import 'package:app_mf_tc/screens/telaAdicionarItemCarrossel.dart';
...
import 'package:app_mf_tc/screens/telaAdicionarItemFatura.dart';
  ...
  runApp(
    MaterialApp(
      ...
      routes: {
        ...
        '/itemFatura': (context) => TelaAdicionarItemFatura(),
        '/itemCarrossel': (context) => TelaAdicionarItemCarrossel(),
      },
    ),
  );
}
